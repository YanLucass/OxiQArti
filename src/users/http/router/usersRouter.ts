    ...
    celebrate({
        [Segments.BODY]: Joi.object().keys({
            ...
            contact: Joi.string().required().messages({
                "any.required":
                    "Por favor, informe pelo menos um contato(Instagram, facebook, linkedin etc)",
            }),
            ...
            role: Joi.string()
                ...
                .messages({
                    ...
                    "any.only":
                        "Os tipos de conta são: onlyArtist(Prestar serviços somente) contractingArtist(prestar e publicar) e onlyContracting(apenas contratar)",
                }),
